...
; (And yet again modified by David Amador, yet again by Amila Manoj) Should work property with XNA 3.1
; SEE THE DOCUMENTATION FOR DETAILS ON CREATING INNO SETUP SCRIPT FILES!
 
; Enter the name of your game here
#define MyAppName "Motion Controlled 3D Flight Simulator"
 
; Enter the name of your game and a version number here
#define MyAppVerName "Flight Simulator 0.9"
 
; Enter the name of your company, or just your name
#define MyCompany "Amila Manoj"
 
; Enter the URL of your website
#define MyAppURL "http://www.facebook.com/pages/Project-ITS/149402655096246"
 
; Enter the path to your game project - check Visual Studio properties for the path
#define MyAppLocation "D:\FlightSim_AMS_final4exmo\FlightSim_AMS"
 
; Enter the name of your game executable
#define MyAppExeName "FlightSim_AMS.exe"
...
; Enter the name for the correct version of the AForge Framework
#define AForgeRedist "AForgeNET212.exe"
 
; Enter the location where you have placed the VC and .NET redistributables
#define MyRedistLocation "D:\FlightSim_AMS_final4exmo\Setup"
...
;SetupIconFile = "D:\FlightSim_AMS_final4exmo\Setup\Game.ico"
;UninstallIconFile = "D:\FlightSim_AMS_final4exmo\Setup\uninstall.gif"
...
Source: {#MyRedistLocation}\{#AForgeRedist}; DestDir: {tmp}
...
Filename: {tmp}\{#AForgeRedist}; Flags: skipifdoesntexist; Parameters: "/silent"
Filename: {tmp}\{#VCRedist}; Flags: skipifdoesntexist;
